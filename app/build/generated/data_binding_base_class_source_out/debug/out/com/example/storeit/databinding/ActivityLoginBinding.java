...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull TextView SignIn,
      @NonNull ImageView background, @NonNull Button enterButton, @NonNull ImageView ico,
      @NonNull TextView login, @NonNull EditText loginEmail, @NonNull EditText loginPassword,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, SignIn, background, enterButton,
          ico, login, loginEmail, loginPassword, main, title);
    }
