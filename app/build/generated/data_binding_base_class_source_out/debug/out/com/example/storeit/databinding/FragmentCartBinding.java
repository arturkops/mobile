...
public final class FragmentCartBinding implements ViewBinding {
  ...
  private FragmentCartBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull RecyclerView cartRecyclerview, @NonNull ImageView imageView2,
  ...
  public static FragmentCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCartBinding((ConstraintLayout) rootView, button, cartRecyclerview,
          imageView2, imageView3, imageView4, imageView5, textView);
    }
